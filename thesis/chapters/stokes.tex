...
$d=2$ or $d=3$. As already described in Section~\ref{sec:free_boundary_flows},
...
approach, see Section~\ref{sec:front_tracking_approach}, which parameterize the
...
\in \uspace^m\times \pnormspace^m \times \Vh \times \Wh$ to
{\rm (\ref{eq:HGa}--d)}.
\end{theorem}
\begin{proof}
