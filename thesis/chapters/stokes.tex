...
$\Omega\subset\R^d$, where $d=2$ or $d=3$. The domain $\Omega$ contains
...
addition, we let $\vol$ and $\surfvol$ denote the Lebesgue
...
\section{Discrete stationary solutions}
...
\section{Mesh generation and smoothing}
