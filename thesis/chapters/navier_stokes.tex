...
\section{Numerical results}\label{sec:ns_numerical_results}
...
$\alpha,\alpha_1,\alpha_2,\gamma\in \R_{\geq 0}$ be given.
...
\end{align}
and $\vec g = \bigg(\alpha_1+\alpha_2\charfcn{\Omega_+(t)}(|\vec
z|^2-r(t)^2)\bigg)\,\vec z$ on $\partial_1\Omega=\partial\Omega$.
...
error of convergence EOC (\ref{eq:eoc}).

Finally, for later use, we define some benchmark quantities for the continuous
...
\subsection{Rising bubble experiment in 2d} \label{sec:2d_rising_bubble_results}
