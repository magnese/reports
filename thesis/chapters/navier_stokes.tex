...
$j = 1 ,\ldots, J^m_\Omega$. On ${\cal T}^m$ we define the finite element spaces
\begin{equation*}
...
\begin{equation}
\begin{align}
\rho\,(\left.\vec u_t\right|_{\Upsilon_{\Omega_\pm}}
+(\vec u - \vec{\mathcal{W}})\,.\, \nabla \vec u)\,
-2 \mu\,\nabla\,.\, \mat D(\vec u)+ \nabla\,p & = \vec f
...
Eulerian frame. Therefore $\vec{\mathcal{W}}=\vec 0$ corresponds to a pure
Eulerian method while $\vec{\mathcal{W}}=\vec u$ corresponds to a fully
Lagrangian scheme.
...
\begin{subequations}
\begin{align}
& \left(\rho\,\left.\vec u_t\right|_{\Upsilon_{\Omega_\pm}}, \vec \xi\right) +
