...
The chapter is organised as follows: in Section~\ref{sec:geometric_pdes} we
...
diffusion; in Section~\ref{sec:geometric_analysis} we present some definitions
and known results from differential geometry which will be employed throughout
the thesis; in Section~\ref{sec:geometric_flows_properties} we report some
fundamental properties of geometric flows, recalling theoretical results already
proven in the literature; in Section~\ref{sec:front_tracking_approach} we
...
Section~\ref{sec:geometric_pdes_fem} we discuss the fully practical finite
...
Section~\ref{sec:geometric_pdes_algebraic} we reformulate the discrete schemes
as algebraic systems of equations and we briefly describe the solution technique
adopted; in Section~\ref{sec:geometric_pdes_results} we report three different
