...
\end{equation*}
and hence the desired result follow immediately.
\end{proof}
...
over all the elements and each contribution is a planar integral in $\R^d$ with
the integrand being a constant, we notice that (\ref{eq:algebraic_entries_c})
can be assembled as the standard Laplacian term.
