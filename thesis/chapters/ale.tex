...
\end{align*}
Moreover, let $(\cdot,\cdot)_{\Omega(t)}$ and $\langle \cdot, \cdot
...
respectively.\footnote{Robert: is $\uspaceale b$ correct or $\vec b$ should be
defined on $\partial_1\Omega(t)$ and the free-slip condition respect to
$\partial_2\Omega(t)$? Moreover for $\pnormspaceale$ zero mean on $\D$ or on
$\Omega(t)$, probably indifferent since we just want to remove a degree of
freedom?}
