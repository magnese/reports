...
a great advantage of ALE methods respect to non-ALE methods because the
interpolation process is expensive in term of CPU time and introduces
interpolations errors. Moreover, the interpolated velocity is no longer,
in discrete weakly sense, divergence-free which leads to possible unphysical
solutions. Therefore, we want to investigate if these downsides of non-ALE
