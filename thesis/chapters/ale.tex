...
temporal discretization. Therefore, applying an implicit Euler scheme to
...
\begin{subequations}
\begin{align}
& \left( \rho^m\,\frac{\vec U^{m+1}}{\tau_m}, \vec \xi \right)_{\Omega^{m+1}}
...
\nonumber \\
& \qquad=  \left( \rho^m\,\frac{\vec U^m}{\tau_m}, \vec \xi \right)_{\Omega^m}
