...
(\ref{eq:LAb_nondivfree}) is zero since $f_{\rm{div}}$ can be moved outside
the integral and what remains is simply the mean of a zero-mean function.
...
\quad \forall\ \varphi \in \pnormspace^m\,, \\
