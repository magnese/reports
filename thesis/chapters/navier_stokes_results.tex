...
$V_{c,\max}$                     & 0.2501 & 0.2503 \\
$t_{V_c = V_{c,\max}}$           & 0.7290 & 0.7290 \\
...
0.5144, 3.0000, 0.2502, 0.7317 and 1.1376. Here we note that there is little
agreement on these results between the three groups in \cite{HysingTKPBGT09},
but we believe the numbers of group 3 to be the most reliable ones. Similar
results are also obtained in \cite{fluidfbp}.
