...
Finally, we also define the estimated order of convergence EOC as
...
is now very smooth in comparison to the one reported in
...
Finally we want to compare the performance of different preconditioners
...
increase of the restart value obviously reduces the number of GMRES iterations
but also drastically increases the memory footprint. Moreover, the application
of the preconditioner consists of doing the backward substitution
