...
\newcommand{\uspaceref}[1]{\mathcal{U}(\vec{#1})} % ale reference velocity space
\newcommand{\pspaceref}{\mathcal{P}} % ale reference pressure space
\newcommand{\pnormspaceref}{\widetilde\pspaceref}
% ale reference normalized pressure space
\newcommand{\uspaceale}[1]{\mathfrak{U}(\vec{#1})} % ale velocity space
\newcommand{\pspaceale}{\mathfrak{P}} % ale pressure space
\newcommand{\pnormspaceale}{\widetilde\pspaceale}% ale normalized pressure space
