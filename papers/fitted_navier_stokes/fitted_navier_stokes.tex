...
\begin{equation}
y_c^{m+1} = \frac1{\mathcal{L}^2(\Omega_-^m)}\,\int_{\Omega_-^m} x_2^{m} \dL2\,,
\end{equation}
\begin{equation}
\strikec^{m+1} =
...
\end{equation}
\begin{equation}
V^{m+1}_c = \frac1{\mathcal{L}^2(\Omega_-^m)}\,\int_{\Omega_-^m}
U^{m+1}_2\dL2\,.
\end{equation}
...
& 64 & 128 & reference \\
\hline
$\strikec_{\min}$ & 0.898608 & 0.899627 & 0.9014 \\
$t_{\strikec = \strikec_{\min}}$ & 1.931 & 1.919 & 1.9000 \\
$V_{c,\max}$ & 0.237903 & 0.240766 & 0.2417 \\
$t_{V_c = V_{c,\max}}$ & 0.944 & 0.928 & 0.9230 \\
$y_c(t=3)$ & 1.07764 & 1.07994 & 1.0819 \\
CPU & 18448 & 66889 & \\
\hline
\end{tabular}
