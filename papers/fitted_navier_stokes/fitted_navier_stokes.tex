...
help of an iterative solution and smoothing procudure, see the next section for
more details.
...
In this subsection we disuss the solution methods and other implementation
...
experiments in \S\ref{sec:ns_exact_solutions}. Here the condition 
...
(\ref{eq:elast}), see \S\ref{sec:smoothing} for more details, 
