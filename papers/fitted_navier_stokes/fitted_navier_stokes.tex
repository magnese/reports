...
nonlinear schemes. Finally, we note that the number of full remeshings performed
when $J_\Gamma = 32$ is, depending on the scheme, between 1 and 4  while it was
always 0 in all the other simulations for this test case.
...
$(\schemeAex)$, $(\schemeAim)$ and $(\schemeALE)$ is 10\,638, 10\,716 and
9\,972, respectively.
\begin{table*}
\center
\hspace*{-3.25cm}
...
$(\schemeAim)$ and $(\schemeALE)$ is 787, 788 and 808, respectively.
