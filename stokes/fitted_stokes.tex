...
$\Gamma^m$ be a polyhedral surface with constant discrete mean curvature, i.e.\ 
there exists a constant $\overline{\kappa}\in\mathbb{R}$ such that
...
(\R^d)^{K^\Gamma}$ here denote the coefficients of these finite element 
...
remeshing paramter $C_r=3$ during the evolution.
