...
Tables~\ref{tab:bubble2Dp2p0} and \ref{tab:bubble2Dp2p1p0}.
%\footnote{Marco: Maybe combine the two tables into one, with two columns for
%CPU time.}
...
\begin{figure}[htbp]
  \centering
  \subfloat[$t=0$]{\includegraphics[width=.32\textwidth]{figures/expanding_bubble_uniform_000.ps}}
  \subfloat[$t=0.5$]{\includegraphics[width=.32\textwidth]{figures/expanding_bubble_uniform_050.ps}}
  \subfloat[$t=1$]{\includegraphics[width=.32\textwidth]{figures/expanding_bubble_uniform_100.ps}}
