...
\begin{figure}[htbp]
  ...
  \caption{Initial fitted uniform meshes for the 2D stationary bubble problem (a) and for the 2D expanding bubble problem (b) with 32 interface elements.}
...
Figure~\ref{fig:ellipse_bulk_inner_volume} shows the evolution of the bulk inner relative volume $\frac{\mathcal{L}^d(\Omega^h_-(t))}{\mathcal{L}^d(\Omega^h_-(0))}$ while Figure~\ref{fig:ellipse_interface_length} shows the evolution of the interface length $\mathcal{H}^{d-1}(\Gamma^h(t))$.
\begin{figure}[htbp]
  \centering
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/ellipse_000.ps}}\\
...
\begin{figure}[htbp]
  ...
  \caption{Ellipse evolution bulk inner relative volume for P2--P0 with $c_l=0.1$, $C_s=1.0$ and $C_r=3.0$.}
...
\begin{figure}[htbp]
  ...
  \caption{Ellipse evolution interface length for P2--P0 with $c_l=0.1$, $C_s=1.0$ and $C_r=3.0$.}
  \label{fig:ellipse_interface_length}
\end{figure}

Instead, in Figure~\ref{fig:ellipse_smooth} the remeshing coefficient is $C_r=0.0$ so only the smoothing is used. The evolution of the bulk inner relative volume and the evolution of the interface length are shown in Figure~\ref{fig:ellipse_smooth_bulk_inner_volume} and in Figure~\ref{fig:ellipse_smooth_interface_length}, respectively.
\begin{figure}[htbp]
  \centering
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/ellipse_smooth_000.ps}}\\
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/ellipse_smooth_100.ps}}\quad
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/ellipse_smooth_200.ps}}\\
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/ellipse_smooth_300.ps}}\quad
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/ellipse_smooth_400.ps}}\\
  \caption{Ellipse evolution P2--P0 with $c_l=0.1$, $C_s=1.0$ and no remeshing for (a) $t=0$, (b) $t=1$, (c) $t=2$, (d) $t=3$, (e) $t=4$.}
...
\begin{figure}[htbp]
  ...
  \caption{Ellipse evolution bulk inner relative volume for P2--P0 with $c_l=0.1$, $C_s=1.0$ and no remeshing.}
...
\begin{figure}[htbp]
  ...
  \caption{Ellipse evolution interface length for P2--P0 with $c_l=0.1$, $C_s=1.0$ and no remeshing.}
...
\begin{figure}[htbp]
  \centering
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_000.ps}}\\
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_025.ps}}\quad
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_050.ps}}\\
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_075.ps}}\quad
...
\begin{figure}[htbp]
  \centering
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_adaptive_000.ps}}\\
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_adaptive_025.ps}}\quad
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_adaptive_050.ps}}\\
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/expanding_bubble_adaptive_075.ps}}\quad
...
\begin{figure}[htbp]
  ...
  \caption{2D Shear flow bulk inner relative volume evolution for P2--P0 with $c_l=0.1$, $C_s=1.0$ and $C_r=3.0$.}
  \label{fig:shear_2d_bulk_inner_volume}
\end{figure}

Instead, in Figure~\ref{fig:shear_2d_smooth} the remeshing coefficient is $C_r=0.0$ so only the smoothing is used. The bulk inner relative volume evolution is reported in Figure~\ref{fig:shear_2d_smooth_bulk_inner_volume}.
\begin{figure}[htbp]
  \centering
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/2d_shear_smooth_050.ps}}\quad
  ...
  \caption{2D Shear flow pressure evolution for P2--P0 with $c_l=0.1$, $C_s=1.0$ and no remeshing for (a) $t=0.5$, (b) $t=1.0$, (c) $t=1.5$ and (d) $t=2.0$.}
...
\begin{figure}[htbp]
  ...
  \caption{2D Shear flow bulk inner relative volume evolution for P2--P0 with $c_l=0.1$, $C_s=1.0$ and no remeshing.}
...
\end{equation*}
and we use the parameters $\mu=1$, $\gamma=3$, $\tau=10^{-2}$ and $T=5$. In Figure~\ref{fig:shear_3d} is reported the interface evolution of the sphere with initial characteristic length $c_l=0.125$, smoothing coefficient $C_s=1.0$ and remeshing coefficient $C_r=3.0$. The characteristic length for the boundary is fixed and not uniform like in the 2D case. The bulk inner relative volume evolution $\frac{\mathcal{L}^d(\Omega^h_-(t))}{\mathcal{L}^d(\Omega^h_-(0))}$ is reported in Figure~\ref{fig:shear_3d_bulk_inner_volume}.
\begin{figure}[htbp]
  \centering
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/3d_shear_000.ps}}\\
  \subfloat[][]{\includegraphics[width=.45\textwidth]{images/3d_shear_050.ps}}\quad
  ...
  \caption{3D Shear flow interface evolution for P2--P0 with $c_l=0.125$, $C_s=1.0$ and $C_r=3.0$ for (a) $t=0.0$, (b) $t=0.5$, (c) $t=1.0$, (d) $t=2.5$ and (e) $t=5.0$.}
  \label{fig:shear_3d}
\end{figure}
...
\begin{figure}[htbp]
  ...
  \caption{3D Shear flow bulk inner relative volume evolution for P2--P0 with $c_l=0.125$, $C_s=1.0$ and $C_r=3.0$.}
